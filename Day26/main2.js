...
const tenSpokenLanguages = (countries) => {
    ...
    nameButton.addEventListener('click',event => {
        ...
        if(nameClicked % 2 ==0) {
            sortedArray.reverse()
           //const x = document.createTextNode(<i class="fas fa-arrow-up"></i>)
           //nameButton.appendChild(x)
        }
        countriesDislay.textContent = ''
    ...
    nameButton.addEventListener('mouseover', event => {
        if(nameClicked == 0) {
            nameButton.innerHTML = 'Name<i class="fas fa-long-arrow-alt-up"></i>'
        }
        else {
            nameButton.innerHTML = 'Name<i class="fas fa-long-arrow-alt-down"></i>'
        }
    })
